...
- 真实 SettingsProvider/LLM 回归、真实页面可写 smoke 与候选隔离安装已经完成；发布前仍需关闭双平台 CI、main CI 与最终唯一制品门禁。
